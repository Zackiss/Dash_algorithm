...
def influence_control(graph, mastery, pnode, visit_nodes=None, visit_threshold=1, allow_shortcut=True, no_pre=None,
    ...
    """
    The influence control is specially used for reducing the hypothesis(search) space.
    It restricts all the active knowledge that going to be learnt by learners and
    the learning path not considered by influence control should not be recommended
