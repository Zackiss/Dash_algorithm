...
class Logger:
    ...
    def one_epoch(self, epoch, train_metric_dict, test_metric_dict, model):
        ...
        self._auc_append(train_metric_dict['auc'], test_metric_dict['auc'])

    def one_run(self, args):
        self._get_time()
        # self._draw()

        result_dict = {'t': self.end_time,
    ...
    def _auc_append(self, train_auc, test_auc):
    ...
    def _log_writer(self, log):
        print(log.rstrip('\n'))
        self.log_writer.write(log)

    def _result_writer(self, result):
        print(result.rstrip('\n'))
